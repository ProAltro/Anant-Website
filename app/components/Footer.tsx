    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-anant-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="text-gray-400 hover:text-anant-accent transition-colors">
                  About Us
                </a>
              </li>
              <li>
                <a href="#team" className="text-gray-400 hover:text-anant-accent transition-colors">
                  Our Team
                </a>
              </li>
              <li>
                <a href="#publications" className="text-gray-400 hover:text-anant-accent transition-colors">
                  Publications
                </a>
              </li>
              <li>
                <a href="#contact" className="text-gray-400 hover:text-anant-accent transition-colors">
                  Contact
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Team Anant - BITS Pilani. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
