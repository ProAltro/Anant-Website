...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "TTC Team - Team Anant" },
    { name: "description", content: "Meet the Telemetry, Tracking and Command Subsystem team members of Team Anant." },
  ];
}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-anant-mild max-w-4xl mx-auto">
                Our TTC team handles all communication aspects of the satellite, including telemetry data transmission, 
                ground tracking, and command reception from ground stations.
              </p>
            </div>
